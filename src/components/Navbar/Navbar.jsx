...
const Navbar = () => {
    ...
    return (
        <div className="fixed w-full z-10">
            <nav className="list-none w-full xl:w-[1800px] h-20 md:h-28 mx-auto px-4 lg:px-10 md:px-12 bg-gray-900 bg-opacity-70 flex justify-between items-center backdrop-filter backdrop-blur-sm shadow-xl">
                <div className="lg:hidden w-full flex justify-between items-center lg:flex-none">
                    <div className="w-[100px]">
                        <img className="w-full h-full object-cover" src="/img/global/mt-logo-light.png" alt="" />
                    </div>
